...
interface SignupModalProps {
  ...
  signupSuccessToast: (message: string) => void;
  signupFailedToast: (message: string) => void;
}

const SignupModel: React.FC<SignupModalProps> = ({
  handleSignState,
  signupSuccessToast,
  signupFailedToast,
}) => {
  ...
  const handleSignupDetails = (e: ChangeEvent<HTMLInputElement>) => {
  ...
  const handleDataInsert = async (e: FormEvent) => {
    e.preventDefault();
