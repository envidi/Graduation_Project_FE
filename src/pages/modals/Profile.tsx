...
interface FormValues {
 ...
 const Profile = () => {
  ...
  const userUpdate = useMutation({
    mutationFn : async (user :FormValues) => await updateUser(user),
    onSuccess() {
  ...
  const formikValidate = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await userUpdate.mutateAsync(values);
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    formikValidate.setFieldValue(name, value);
  };
        ...
        <div className="login-form2 overlay overflow-y-hidden">
          ...
          <form onSubmit={formikValidate.handleSubmit}>
            <div className="flex justify-center items-center">
              <div className='relative'>
                    <img src={userDetail?.message?.avatar} alt="" className='w-40 h-40 border-red-400 border rounded-full'/>
              </div>
              <button type="button" className="btn-form-exit absolute top-9 right-8 p-2" onClick={handleShow}>
            ...
            <div className="signup-form-category">
              ...
              <input
                ...
                defaultValue={userDetail?.message?.name}
            ...
            <div className="signup-form-body">
              <div className="signup-form-category">
                ...
                onChange={formikValidate.handleChange}
                  ...
                  defaultValue={userDetail?.message?.email}
          ...
          <div className="signup-form-category">
            ...
            <input
              name="mobile"
              type="text"
              value={userDetail?.message?.mobile}
          ...
          {formikValidate.touched.address &&
            ...
            <div className="signup-form-category">
              ...
              defaultValue={userDetail?.message?.address}
