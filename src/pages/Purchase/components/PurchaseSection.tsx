...
<<<<<<< HEAD
  ...
  //   locationData: any,
  //   userLocation: any,
  //   handleLocationSelection: any,
  //   theatreId: string,
  //   handleUserDateChange: any,
  //   userDate: any,
  //   datesData: any,
  //   getMovieData: any,
  //   movieData: any,
  //   userMovieId: string,
  //   handleUserMovieChange: any,
  //   userShowtimeId: string,
  //   userHallId: string,
  //   getHallData: any,
  //   hallData: any,
  //   handleUserHallShow: any,
  //   getTheatreData: any,
  //   signedPerson: any,
  //   userSeatPrice: number,
  //   getShowDatesData: any,
  //   seatsData: any,
  //   getSeatsData: any,
  //   handleUserSeats: any,
  //   userSeatList: any,
  ...
  //   curHallObj: any,
  //   currentMovie: any,
  //   userSeatListName: any,
  //   handleUserPaymentMethod: any,
  //   userPayMethod: any,
  //   clearUserSelection: any,
  //   ticketPurchaseError: any,
  //   purchaseCompletion: any,
  // }

  // export const PurchaseSection :React.FC<Props>= ({
  //   locationData ,
  //   userLocation,
  ...
  //       ticketIds.forEach((ticket :{id:number}) => {
