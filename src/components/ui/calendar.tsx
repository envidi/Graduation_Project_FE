  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: 'space-x-1 flex items-center pb-10 pt-8 ',
        nav_button: cn(
        ...
        day_selected:
          'bg-primary-movieColor text-primary-foreground hover:bg-primary-movieColor hover:text-primary-foreground focus:bg-primary-movieColor focus:text-primary-foreground',
