...
const TableRooms = () => {
  ...
  return (
    <>
      ...
      {/* Room Table */}
      <div className="rounded-sm border bg-white border-stroke bg-primary px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
