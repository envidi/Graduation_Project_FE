     ...
     style={{backgroundColor:'#1c2434'}}>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-4 font-semibold text-bodydark2 text-2xl text-gray-400">
              MENU
            </h3>

            <ul className="mb-6 flex flex-col gap-1.5 text-xl">
              {/* <!-- Menu Item Dashboard --> */}
              <SidebarLinkGroup
                activeCondition={
          ...
          {/* <!-- Others Group --> */}
          <div>
            <h3 className="mb-4 ml-4  font-semibold text-bodydark2 text-gray-400 text-2xl">
              OTHERS
            </h3>
