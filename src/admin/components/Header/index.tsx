...
const Header = (props: {
  ...
  onSearch: (keyword: string, type: string) => void;  // Updated onSearch to accept type
}) => {
  const [searchTerm, setSearchTerm] = useState('');
  const [searchType, setSearchType] = useState('food');  // State to store the type of data to search

  const handleSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const keyword = e.target.value;
    setSearchTerm(keyword);
    props.onSearch(keyword, searchType);  // Passing searchType to onSearch
  };
